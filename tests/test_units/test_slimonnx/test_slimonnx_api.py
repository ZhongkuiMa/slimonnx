...
class TestSlimONNXPreprocess:
    ...
    def test_preprocess_basic(self, slim_onnx, create_dropout_model):
        ...
        try:
            preprocessed = slim_onnx.preprocess(temp_path)
    ...
    def test_preprocess_clears_docstrings(self, slim_onnx, create_conv_bn_model):
        ...
        try:
            preprocessed = slim_onnx.preprocess(temp_path, clear_docstrings=True)
    ...
    def test_preprocess_marks_slimonnx(self, slim_onnx, create_dropout_model):
        ...
        try:
            preprocessed = slim_onnx.preprocess(temp_path, mark_slimonnx=True)

            # Check preprocessing completed
            assert preprocessed  # Preprocessing should complete
        finally:
            Path(temp_path).unlink(missing_ok=True)
...
class TestSlimONNXAnalyze:
    ...
    def test_analyze_basic(self, slim_onnx, create_matmul_add_model):
        ...
        try:
            analysis = slim_onnx.analyze(temp_path)
    ...
    def test_analyze_returns_dict(self, slim_onnx, create_dropout_model):
        ...
        try:
            result = slim_onnx.analyze(temp_path)
...
class TestSlimONNXDetectPatterns:
    ...
    def test_detect_patterns_with_matmul_model(self, slim_onnx, create_matmul_add_model):
        """Test pattern detection on matmul model."""
        model = create_matmul_add_model()
        ...
        try:
            patterns = slim_onnx.detect_patterns(temp_path)
    ...
    def test_detect_patterns_returns_dict(self, slim_onnx, create_dropout_model):
        ...
        try:
            result = slim_onnx.detect_patterns(temp_path)
...
class TestSlimONNXValidate:
    ...
    def test_validate_basic(self, slim_onnx, create_dropout_model):
        ...
        try:
            validation_result = slim_onnx.validate(temp_path)
    ...
    def test_validate_returns_dict(self, slim_onnx, create_conv_bn_model):
        ...
        try:
            result = slim_onnx.validate(temp_path)
...
class TestSlimONNXCompare:
    ...
    def test_compare_identical_models(self, slim_onnx, create_dropout_model):
        ...
        try:
            comparison = slim_onnx.compare(temp_path1, temp_path2)
    ...
    def test_compare_returns_dict(self, slim_onnx, create_matmul_add_model):
        ...
        try:
            result = slim_onnx.compare(temp_path1, temp_path2)
...
class TestSlimONNXSlim:
    ...
    def test_slim_basic(self, slim_onnx, create_dropout_model):
        ...
        try:
            slim_onnx.slim(input_path, output_path)
    ...
    def test_slim_creates_output_file(self, slim_onnx, create_matmul_add_model):
    ...
    def test_slim_with_config(self, slim_onnx, create_dropout_model):
        ...
        try:
            ...
            slim_onnx.slim(input_path, output_path, config=config)
    ...
    def test_slim_default_output_path(self, slim_onnx, create_dropout_model):
        ...
        try:
            slim_onnx.slim(input_path)  # No target_path specified
...
class TestSlimONNXValidateOutputs:
    ...
    def test_validate_outputs_identical_models(self, slim_onnx, create_dropout_model):
        ...
        try:
            result = slim_onnx.validate_outputs(path1, path2)
...
class TestSlimONNXIntegration:
    ...
    def test_slim_creates_parent_directories(self, slim_onnx, create_dropout_model):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            slim_onnx.slim(str(input_path), str(output_path))
