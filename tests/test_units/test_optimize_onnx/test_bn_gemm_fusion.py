...
class TestFuseGemmReshapeBn:
    ...
    def test_fuses_gemm_reshape_bn_chain(self):
    ...
    def test_keeps_single_relu_when_no_gemm_chain(self):
    ...
    def test_fuses_when_trans_b_is_set(self):
    ...
    def test_handles_or_rejects_trans_a(self):
...
class TestFuseBnGemm:
    ...
    def test_fuses_bn_gemm_pair(self):
    ...
    def test_keeps_single_relu_when_no_bn_gemm(self):
        """Test no fusion when pattern missing."""
        X = create_tensor_value_info("X", "float32", [2, 3])
        Y = create_tensor_value_info("Y", "float32", [2, 3])
    ...
    def test_fuses_with_nonzero_bn_bias(self):
...
class TestFuseBnReshapeGemm:
    ...
    def test_fuses_bn_reshape_gemm_chain(self):
    ...
    def test_keeps_single_relu_when_no_bn_chain(self):
        """Test no fusion when pattern missing."""
        X = create_tensor_value_info("X", "float32", [2, 3])
        Y = create_tensor_value_info("Y", "float32", [2, 3])
    ...
    def test_fuses_two_chained_bn_reshape_gemm_patterns(self):
