...
class TestFuseConvBn:
    ...
    def test_fuses_basic_pair(self):
    ...
    def test_fuses_without_conv_bias(self):
    ...
    def test_fuses_with_multiple_channels(self):
    ...
    def test_skips_when_conv_has_branching(self):
    ...
    def test_fuses_chained_pairs(self):
...
class TestFuseBnConv:
    ...
    def test_skips_with_conv_padding(self):
    ...
    def test_skips_when_bn_has_branching(self):
